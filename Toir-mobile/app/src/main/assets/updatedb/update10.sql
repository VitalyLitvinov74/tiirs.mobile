...
insert into 'users' ('uuid', 'name', 'login', 'pass', 'type', 'tag_id', 'active', 'whois') values('4462ed77-9bf0-4542-b127-f4ecefce49da', 'Иванов О.А.', 'admin', 'admin', 3, '01234567', 1,"Ведущий инженер");
