...
public class OperationPatternStepResultDBAdapter extends BaseDBAdapter {
	...
	public static final class Projection {
		...
		public static final String OPERATION_PATTERN_STEP_UUID = TABLE_NAME
				+ '_' + FIELD_OPERATION_PATTERN_STEP_UUID;
		public static final String NEXT_OPERATION_PATTERN_STEP_UUID = TABLE_NAME
				+ '_' + FIELD_NEXT_OPERATION_PATTERN_STEP_UUID;
		public static final String TITLE = TABLE_NAME + '_' + FIELD_TITLE;
		public static final String MEASURE_TYPE_UUID = TABLE_NAME + '_'
	...
	public OperationPatternStepResult getItem(Cursor cursor) {
		...
		result.setOperation_pattern_step_uuid(cursor.getString(cursor
				.getColumnIndex(FIELD_OPERATION_PATTERN_STEP_UUID)));
		result.setNext_operation_pattern_step_uuid(cursor.getString(cursor
				.getColumnIndex(FIELD_NEXT_OPERATION_PATTERN_STEP_UUID)));
		result.setTitle(cursor.getString(cursor.getColumnIndex(FIELD_TITLE)));
		result.setMeasure_type_uuid(cursor.getString(cursor
				.getColumnIndex(FIELD_MEASURE_TYPE_UUID)));
		return result;
	}
	...
	public ArrayList<OperationPatternStepResult> getItems(String step_uuid) {
		...
		cursor = mDb.query(TABLE_NAME, mColumns,
				...
				new String[] { step_uuid }, null, null, null);
		if (cursor.moveToFirst()) {
	...
	/**
	 * Возвращает список результатов связанных с шагами переданными в качестве
	 * параметра
	 * 
	 * @param steps_uuids
	 * @return
	 */
	public ArrayList<OperationPatternStepResult> getItems(
			ArrayList<String> steps_uuids) {
		ArrayList<OperationPatternStepResult> stepResults = null;
		Cursor cursor;
		...
		cursor = mDb.query(
				TABLE_NAME,
				mColumns,
				FIELD_OPERATION_PATTERN_STEP_UUID + " IN ("
	...
	public long replace(OperationPatternStepResult item) {
		...
		values.put(FIELD_OPERATION_PATTERN_STEP_UUID,
				item.getOperation_pattern_step_uuid());
		values.put(FIELD_NEXT_OPERATION_PATTERN_STEP_UUID,
				item.getNext_operation_pattern_step_uuid());
	...
	public boolean saveItems(ArrayList<OperationPatternStepResult> list) {
