...
import ru.toir.mobile.multi.db.migration.Migration26;
import ru.toir.mobile.multi.db.migration.Migration27;
import ru.toir.mobile.multi.db.migration.Migration28;
import ru.toir.mobile.multi.db.migration.Migration29;
import ru.toir.mobile.multi.db.migration.Migration30;
import ru.toir.mobile.multi.db.migration.Migration31;
import ru.toir.mobile.multi.db.migration.Migration32;
import ru.toir.mobile.multi.db.migration.Migration33;
import ru.toir.mobile.multi.db.migration.Migration34;
import ru.toir.mobile.multi.db.migration.Migration35;
import ru.toir.mobile.multi.db.migration.Migration36;
import ru.toir.mobile.multi.db.migration.Migration37;
import ru.toir.mobile.multi.db.migration.Migration38;
import ru.toir.mobile.multi.db.migration.Migration39;
import ru.toir.mobile.multi.db.migration.Migration40;
import ru.toir.mobile.multi.db.migration.Migration41;
import ru.toir.mobile.multi.db.migration.Migration42;
import ru.toir.mobile.multi.db.migration.Migration43;
import ru.toir.mobile.multi.db.migration.Migration44;
import ru.toir.mobile.multi.db.migration.Migration45;
import ru.toir.mobile.multi.db.migration.Migration46;
import ru.toir.mobile.multi.db.migration.Migration47;
...
class ToirRealmMigration implements RealmMigration {
    ...
    public void migrate(DynamicRealm realm, long oldVersion, long newVersion) {
        ...
        if (oldVersion == 45) {
            new Migration46().migration(realm);
            oldVersion++;
        }

        if (oldVersion == 46) {
            new Migration47().migration(realm);
            oldVersion++;
        }
