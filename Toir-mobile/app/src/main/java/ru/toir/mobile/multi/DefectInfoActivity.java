...
import static ru.toir.mobile.multi.fragments.OrderFragment.copyFile;
...
public class DefectInfoActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        if (defect.getEquipment().getTitle().length() > 35) {
            tv_equipment_text_uuid.setText(defect.getEquipment().getTitle().substring(0, 33));
        } else {
