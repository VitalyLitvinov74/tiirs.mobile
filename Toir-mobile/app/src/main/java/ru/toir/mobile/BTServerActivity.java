...
public class BTServerActivity extends Activity {
        ...
        public boolean handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case BTRfidServer.SERVER_STATE_WAITING_CONNECTION:
                    ...
                    serverStatusTextView.setText("Ожидание входящего соединения от клиента...");
                    break;
                    ...
                    switch (msg.arg1) {
                        ...
                        case RfidDialog.READER_COMMAND_READ_DATA_ID:
                            ...
                            if (bundle != null) {
                                ...
                                int address = bundle.getInt("address");
                                int count = bundle.getInt("count");
                                readTagDataId(password, tagId, memoryBank, address, count);
                            }
                            break;
                        ...
                        case RfidDialog.READER_COMMAND_WRITE_DATA_ID:
                            ...
                            if (bundle != null) {
                                ...
                                int address = bundle.getInt("address");
                                String data = bundle.getString("data");
                                writeTagDataId(password, tagId, memoryBank, address, data);
                            }
                            break;

                        case RfidDialog.READER_COMMAND_READ_MULTI_ID:
                            Log.d(TAG, "Чтение множества меток...");
                            if (bundle != null) {
                                String[] tagIds = bundle.getStringArray("tagIds");
                                readMultiTagId(tagIds);
                            }
                            break;
    ...
    protected void onStart() {
        ...
        if (!mBluetoothAdapter.isEnabled()) {
            Intent intentStartBT = new Intent(BluetoothAdapter.ACTION_REQUEST_ENABLE);
