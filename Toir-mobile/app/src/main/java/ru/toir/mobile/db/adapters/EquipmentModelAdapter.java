        ...
        if (adapterData != null && viewHolder.title !=null) {
                ...
                if (equipmentModel != null) {
                    ...
                    if (equipmentModel.getImage() != null) {
                        String path = context.getExternalFilesDir("/equipmentmodels") + File.separator;
                        //String path = getPicturesDirectory(context) + "equipments" + File.separator;
                        Bitmap image_bitmap = getResizedBitmap(path, equipmentModel.getImage(), 300, 0, equipmentModel.getChangedAt().getTime());
