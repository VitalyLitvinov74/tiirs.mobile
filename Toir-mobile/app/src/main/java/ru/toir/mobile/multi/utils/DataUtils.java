...
import ru.toir.mobile.multi.rfid.EquipmentTagStructure;
import ru.toir.mobile.multi.rfid.TagRecordStructure;
import ru.toir.mobile.multi.rfid.UserTagStructure;
...
public class DataUtils {
    ...
    public static byte[] hexStringTobyte(String str) {
        ...
        char[] achar = str.toUpperCase().toCharArray();
        //String temp = "";
        for (int i = 0; i < len; i++) {
            int pos = i * 2;
    ...
    public static String toHexString(byte[] b) {
        ...
        for (byte tmpByte : b) {
            buffer.append(toHexString1(tmpByte));
        }
    ...
    public static String getNormative(long secs) {
        if (secs <= 180)
            return String.format(Locale.US, "%dс.", secs);
        if (secs < 3600)
            return String.format(Locale.US, "%dмин.%dс.", secs / 60, secs % 60);
        return String.format(Locale.US, "%dч.%dмин.", secs / 3600, (secs % 3600) / 60);
    }
}