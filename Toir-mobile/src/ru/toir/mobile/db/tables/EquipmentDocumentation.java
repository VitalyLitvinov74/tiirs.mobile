...
public class EquipmentDocumentation {		
		...
		public EquipmentDocumentation(long _id, String uuid, String equipment_uuid, String documentation_type_uuid, String title, String path, long createdAt, long changedAt) {
			this._id = _id;
			this.uuid = uuid;
