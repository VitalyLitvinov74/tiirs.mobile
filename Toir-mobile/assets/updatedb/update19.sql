...
create table 'operation_pattern_new' ('_id' integer not null primary key, 'uuid' text not null unique, 'title' text not null, 'operation_type_uuid' integer not null);
