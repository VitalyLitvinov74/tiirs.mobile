...
create table 'task' ('uuid' text not null primary key, 'users_uuid' text not null, 'create_date' text not null, 'modify_date' text not null, 'close_date' text not null default '0000-00-00 00:00:00', 
'task_status_uuid' text not null, 'attempt_send_date' text not null default '0000-00-00 00:00:00', 'attempt_count' integer not null default 0, 'successefull_send' integer not null default 0);
