CREATE TABLE 'version' ( 'id' INTEGER NOT NULL PRIMARY KEY UNIQUE, 'name' INTEGER NOT NULL, 'date' NUMERIC NOT NULL, 'key' TEXT NOT NULL);
INSERT INTO 'version' VALUES (1,0.1,1427875663,'');
CREATE TABLE 'var' ( 'id' INTEGER NOT NULL PRIMARY KEY UNIQUE, 'name' TEXT NOT NULL, 'prm' INTEGER NOT NULL, 'podp' INTEGER NOT NULL);
CREATE TABLE 'users' ( 'id' INTEGER NOT NULL PRIMARY KEY UNIQUE, 'name' TEXT, 'login' TEXT, 'pass' TEXT, 'type' INTEGER);
INSERT INTO 'users' VALUES (1,'admin','admin','admin',3);
CREATE TABLE 'tasks_status' ( 'id' INTEGER NOT NULL PRIMARY KEY UNIQUE, 'name' TEXT NOT NULL);
...
CREATE TABLE 'tasks_equipment' ( 'id' INTEGER NOT NULL PRIMARY KEY UNIQUE, 'id_task' INTEGER NOT NULL, 'id_eqpm' INTEGER NOT NULL, 'type' INTEGER NOT NULL, 'status' INTEGER NOT NULL, 'date' NUMERIC, 'len' INTEGER, 'link' INTEGER, 'gps1' REAL NOT NULL, 'gps2' REAL NOT NULL, 'qualuty' INTEGER, 'priority' INTEGER);
INSERT INTO 'tasks_equipment' VALUES (1,1,1,100,0,1427875663,50,NULL,55.3421,50.3421,NULL,NULL);
CREATE TABLE 'tasks' ( 'id' INTEGER NOT NULL PRIMARY KEY UNIQUE, 'operator_id' INTEGER NOT NULL, 'date_start' NUMERIC NOT NULL, 'date_end' NUMERIC NOT NULL, 'status' INTEGER NOT NULL);
INSERT INTO 'tasks' VALUES (1,1,1427875663,'',2);
CREATE TABLE 'results' ( 'id' INTEGER NOT NULL PRIMARY KEY UNIQUE, 'name' TEXT NOT NULL, 'type' INTEGER NOT NULL);
...
CREATE TABLE 'register' ( 'id' INTEGER NOT NULL PRIMARY KEY UNIQUE, 'type' INTEGER NOT NULL, 'id_task' INTEGER, 'id_eqpm' INTEGER, 'id_user' INTEGER, 'descr' TEXT, 'date' NUMERIC NOT NULL);
CREATE TABLE 'priority' ( 'id' INTEGER NOT NULL PRIMARY KEY UNIQUE, 'name' TEXT NOT NULL);
CREATE TABLE 'path' ( 'id' INTEGER NOT NULL PRIMARY KEY UNIQUE, 'id_user' INTEGER NOT NULL, 'gps1' REAL NOT NULL, 'gps2' REAL NOT NULL, 'date' NUMERIC);
...
CREATE TABLE 'operators' ( 'id' INTEGER NOT NULL PRIMARY KEY UNIQUE, 'name' TEXT NOT NULL, 'photo' TEXT, 'login' TEXT, 'pass' TEXT, 'whois' TEXT, 'phone' TEXT, 'tasks' INTEGER, 'tasks_completed' INTEGER, 'task_current' INTEGER);
INSERT INTO 'operators' VALUES (1,'Курнаков Иван Иванович','/photo/ivanych.jpg','iv07',NULL,'Руководитель проекта','89227000000',1,0,1);
CREATE TABLE 'operations' ( 'id' INTEGER NOT NULL PRIMARY KEY UNIQUE, 'name' TEXT NOT NULL, 'type' INTEGER);
...
CREATE TABLE 'masters_result' ( 'id' INTEGER NOT NULL PRIMARY KEY UNIQUE, 'id_eqpm' INTEGER NOT NULL, 'type' INTEGER, 'step' INTEGER NOT NULL, 'result' INTEGER NOT NULL, 'date' NUMERIC NOT NULL);
...
CREATE TABLE 'masters' ( 'id' INTEGER NOT NULL PRIMARY KEY UNIQUE, 'id_eqmn' INTEGER NOT NULL, 'id_tasks' INTEGER NOT NULL, 'type' INTEGER NOT NULL, 'step' INTEGER NOT NULL, 'descr' TEXT, 'photo' TEXT, 'result1' TEXT, 'nextstep1' INTEGER, 'result2' TEXT, 'nextstep2' INTEGER, 'result3' TEXT, 'nextstep3' INTEGER);
...
CREATE TABLE 'events' ( 'id' INTEGER NOT NULL PRIMARY KEY UNIQUE, 'name' INTEGER NOT NULL);
CREATE TABLE 'equipment' ( 'id' INTEGER NOT NULL PRIMARY KEY UNIQUE, 'name' TEXT NOT NULL, 'link' TEXT, 'type' INTEGER NOT NULL, 'year' INTEGER, 'manufacturer' TEXT, 'photo' TEXT, 'priority' INTEGER);
INSERT INTO 'equipment' VALUES (1,'Корректор газа СПГ741','\docs\re741.pdf',100,2013,'ЗАО НПФ Логика','\photo\3234.jpg',NULL);
CREATE TABLE 'docs' ( 'id' INTEGER NOT NULL PRIMARY KEY UNIQUE, 'type' INTEGER NOT NULL, 'link' TEXT NOT NULL);
INSERT INTO 'docs' VALUES (1,2,'\docs\re254.pdf');
CREATE TABLE 'doc_type' ( 'id' INTEGER NOT NULL PRIMARY KEY UNIQUE, 'name' TEXT NOT NULL);
...
CREATE TABLE 'data' ( 'id' INTEGER, 'id_eqmn' INTEGER NOT NULL PRIMARY KEY UNIQUE, 'prm' INTEGER NOT NULL, 'podp' INTEGER NOT NULL, 'date' NUMERIC NOT NULL, 'id_user' INTEGER, 'id_tasks' INTEGER, 'value' REAL NOT NULL);
